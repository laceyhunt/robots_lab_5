...
#main()
def send_coordinates_mqtt(client):
    coords_to_send = open("img_die_loc.txt", "r").read()
    mqtt_module.publish(client, mqtt_module.package_json(coords_to_send, True), mqtt_module.coord_topic)
